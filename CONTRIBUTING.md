...
# Contributing code to Test Suite Configurations

The document provides the guidelines for submitting changes to TS conf.
...
The summary line should:
 ...
 - start with the imperative of a verb, for example:
   ...
   ```
   scripts: enable ice driver build in DPDK
   ```

   ```
   cs: register RSS configuration objects for net-drv-ts
   ```
